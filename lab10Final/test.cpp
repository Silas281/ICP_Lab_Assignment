...
void getStabbedLines (const int xcoord, Line linesArray[], const int MaxLnsSize, const int NumLines, Point pointsArray[], const int MaxPntsSize, Line stabbedLines[], const int MaxStbSize, int& NumOfStbLines){
